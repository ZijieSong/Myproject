...
public class FeedController {
    ...
    public String pullFeeds(Model model){
        ...
        if(localUserId!=0){
            followees = followService.getFollowees(localUserId, EntityType.EntityType_user,0,Integer.MAX_VALUE);
        }
    ...
    public String pushFeeds(Model model){
        ...
        List<String> feedIds = jedisAdapter.lrange(timelineKey,0,9);
